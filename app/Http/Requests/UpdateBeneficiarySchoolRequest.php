...
class UpdateBeneficiarySchoolRequest extends FormRequest
{
    /**
    ...
    {
        return auth()->user()->can('beneficiarys-schools.update');
    }
    ...
    public function rules()
    {
        return [
            ...
            'education_level' => 'nullable|in:Junior,Primary,Secondary,Intermediate',
