...
class StoreBeneficiaryPatientRequest extends FormRequest
{
    /**
    ...
    {
        return auth()->user()->can('beneficiarys-patients.create');
    }
            ...
            'beneficiary_cnic' => [
                ...
                Rule::unique('beneficiaries', 'beneficiary_cnic')
                    ->where(function ($query) {
                        return $query->where('type', $this->type); // Type bhi consider karein
                    })
                    ->ignore($this->route('beneficiarys_patient')),
            ],
