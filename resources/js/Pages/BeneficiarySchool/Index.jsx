  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        router.delete(route('beneficiarys-schools.destroy', id), {
                ...
                <tr className="space-y-3 font-bold" key={item.id}>
                  ...
                  <td className="text-sm">
                    <div className="flex gap-2">
                      <Link href={route('beneficiarys-schools.edit', item.id)} className="bg-gray-800 p-3 rounded-full text-white">
                        <FaEdit />
                      </Link>
                      <Link href={route('beneficiarys-schools.show', item.id)} className="bg-gray-800 p-3 rounded-full text-white">
                        <FaEye />
                      </Link>
