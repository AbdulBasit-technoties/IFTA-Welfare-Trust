...
export default function Index({ auth, level, beneficiarys_education,donors,institutions }) {
    const { data, setData, patch, errors } = useForm({
        beneficiary_name: beneficiarys_education?.beneficiary_name || "",
        guardian_name: beneficiarys_education?.guardian_name || "",
        beneficiary_cnic: beneficiarys_education?.beneficiary_cnic || "",
        guardian_cnic: beneficiarys_education?.guardian_cnic || "",
        email: beneficiarys_education?.email || "",
        beneficiary_contact_no: beneficiarys_education?.beneficiary_contact_no || "",
        guardian_contact_no: beneficiarys_education?.guardian_contact_no || "",
        occupation: beneficiarys_education?.occupation || "",
        date_of_birth: beneficiarys_education?.date_of_birth || "",
        sign: beneficiarys_education?.sign || "",
        household_income: beneficiarys_education?.household_income || "",
        syed: !!beneficiarys_education?.syed,
        orphan: !!beneficiarys_education?.orphan,
        family_members: beneficiarys_education.family_members || "",
        address: beneficiarys_education?.address || "",
        semester: beneficiarys_education?.semester || "",
        course_field: beneficiarys_education?.course_field || "",
        institute_id: beneficiarys_education?.institute_id,
        graduation_year: beneficiarys_education?.graduation_year || "",
        total_semesters: beneficiarys_education?.total_semesters || "",
        last_result: beneficiarys_education?.last_result,
        total_fee: beneficiarys_education?.total_fee || "",
        approved_amount: beneficiarys_education?.approved_amount || "",
        institute_ntn: beneficiarys_education?.institute_ntn || "",
        education_level: beneficiarys_education?.education_level || "",
        reference_name: beneficiarys_education?.reference_name || "",
        reference_contact: beneficiarys_education?.reference_contact || "",
        reference_relation: beneficiarys_education?.reference_relation || "",
        degree_title: beneficiarys_education?.degree_title || "",
        approved: beneficiarys_education?.approved === 1 ? true : false,
        approver_sign: beneficiarys_education?.approver_sign || "",
        did: beneficiarys_education?.did || "",
        approval_date: beneficiarys_education?.approval_date || "",
        approval_letter: !!beneficiarys_education?.approval_letter,
        application: !!beneficiarys_education?.application,
        fee_voucher: !!beneficiarys_education?.fee_voucher,
        bonafide_certificate: !!beneficiarys_education?.bonafide_certificate,
        beneficiary_cnic_submitted: !!beneficiarys_education?.beneficiary_cnic_submitted,
        guardian_cnic_submitted: !!beneficiarys_education?.guardian_cnic_submitted,
        paid_fee_voucher: !!beneficiarys_education?.paid_fee_voucher,
        institute_ntn_submitted: !!beneficiarys_education?.institute_ntn_submitted,
    });

    const submit = (e) => {
        e.preventDefault();
        patch(route('beneficiarys-educations.update',beneficiarys_education.id), {
            preserveScroll: true,
            preserveState: true,
        });
    };
                        ...
                        <div id="FirstForm" className={step === 1 ? "" : "hidden"}>
                            <header className="text-center p-2 bg-gray-800  text-white">
                                <div className="text-center">
                                    <h2 className="sm:text-lg text-[9px] sm:font-medium">HIGHER EDUCATION SUPPORT PROGRAM – BENEFICIARY REGISTRATION FORM</h2>
                            ...
                            <div className="bg-white rounded-md sm:p-6 p-3 grid grid-cols-12 gap-5 items-center">
                                ...
                                <div className="flex items-center col-span-12 gap-2 sm:gap-4">
                                    ...
                                    <Link
                                        href={route('beneficiarys-educations.index')}
                                        className="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-2xl text-xs text-white capitalize tracking-widest hover:border-gray-700 hover:bg-transparent hover:text-gray-800 transition-all duration-500"
                                    >
                                        Cancel
                                    </Link>
                    ...
                    {step === 2 && (
                        <div id="SecondForm" className={step === 2 ? "" : "hidden"}>
                            ...
                            <div className="bg-white rounded-md sm:p-6 p-3 grid grid-cols-12 gap-5 items-center">
                                ...
                                <div className="xl:col-span-3 lg:col-span-4 sm:col-span-6 col-span-12">
                                    <InputLabel htmlFor="course_field" value="Course/Field" />
                                    <TextInput
                                        id="course_field"
                                        className="mt-1 block w-full"
                                        value={data.course_field || ''}
                                        onChange={(e) => setData('course_field', e.target.value)}
                                        required
                                        autoComplete="course_field"
                                        type="text"
                                    />
                                    <InputError className="mt-2" message={errors.course_field} />
                                </div>
                                <div className="xl:col-span-3 lg:col-span-4 sm:col-span-6 col-span-12">
                                ...
                                <div className="xl:col-span-3 lg:col-span-4 sm:col-span-6 col-span-12">
                                    <InputLabel htmlFor="total_semesters" value="Total Semesters" />
                                    <TextInput
                                        id="total_semesters"
                                        className="mt-1 block w-full"
                                        value={data.total_semesters || ''}
                                        onChange={(e) => setData('total_semesters', e.target.value)}
                                        required
                                        autoComplete="total_semesters"
                                        type="number"
                                    />
                                    <InputError className="mt-2" message={errors.total_semesters} />
                                </div>
                                <div className="xl:col-span-3 lg:col-span-4 sm:col-span-6 col-span-12">
