...
export default function Index({ auth, level, beneficiaries, beneficiaryData, donors,institutions }) {
    ...
    useEffect(() => {
        if (beneficiaryData) {
            setData({
                ...
                total_semesters: beneficiaryData.total_semesters || "",
                ...
                graduation_year: beneficiaryData.graduation_year || "",
                last_result: beneficiaryData.last_result || "",
                ...
                education_level: beneficiaryData.education_level || "",
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('beneficiarys-educations.store'), {
            preserveScroll: true,
            preserveState: true,
        });
    };
    ...
    const handleBeneficiaryChange = (e) => {
        ...
        router.visit(route("beneficiarys-educations.create"), {
            method: "get",
            data: { uid: e },
