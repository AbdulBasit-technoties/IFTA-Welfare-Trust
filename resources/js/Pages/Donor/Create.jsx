...
export default function Index({ auth, PaymentMethod, Donationfrequency }) {
            ...
            <section className="py-24 px-10">
                <form onSubmit={submit} className="mt-6" encType="multipart/form-data">
                    ...
                    <div className="bg-white rounded-md sm:p-6 p-2 grid grid-cols-12 gap-5 items-center">
                        ...
                        <div className="xl:col-span-3 lg:col-span-4 sm:col-span-6 col-span-12">
                            <InputLabel htmlFor="identification_document" value="Cnic" />
                            <TextInput
                                id="identification_document"
                                className="mt-1 block w-full"
                                value={data.identification_document || ''}
                                onChange={(e) => setData('identification_document', e.target.files[0])}
                                required
                                isFocused
                                autoComplete="identification_document"
                                type="file"
                            />
                            <InputError className="mt-2" message={errors.identification_document} />
                        </div>
                        <div className="xl:col-span-3 md:col-span-6 sm:col-span-12 col-span-12">
