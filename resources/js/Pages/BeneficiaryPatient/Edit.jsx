...
export default function Index({ auth, MaritalStatus, patientGender, type, beneficiarys_patient, donors }) {

    const { data, setData, patch, errors } = useForm({
        beneficiary_name: beneficiarys_patient?.beneficiary_name || "",
        guardian_name: beneficiarys_patient?.guardian_name || "",
        beneficiary_cnic: beneficiarys_patient?.beneficiary_cnic || "",
        guardian_cnic: beneficiarys_patient?.guardian_cnic || "",
        beneficiary_contact_no: beneficiarys_patient?.beneficiary_contact_no || "",
        guardian_contact_no: beneficiarys_patient?.guardian_contact_no || "",
        occupation: beneficiarys_patient?.occupation || "",
        date_of_birth: beneficiarys_patient?.date_of_birth || null,
        gender: beneficiarys_patient?.gender || "",
        marital_status: beneficiarys_patient?.marital_status || "",
        sign: beneficiarys_patient?.sign || "",
        household_income: beneficiarys_patient?.household_income ?? 0,
        syed: !!beneficiarys_patient?.syed,
        orphan: !!beneficiarys_patient?.orphan,
        family_members: beneficiarys_patient?.family_members ?? 1,
        address: beneficiarys_patient?.address || "",
        hospital_name: beneficiarys_patient?.hospital_name || "",
        dr_name: beneficiarys_patient?.dr_name || "",
        diseases_injury: beneficiarys_patient?.diseases_injury || "",
        total_fee: beneficiarys_patient?.total_fee ?? 0,
        last_checkup_date: beneficiarys_patient?.last_checkup_date || null,
        reference_name: beneficiarys_patient?.reference_name || "",
        reference_contact: beneficiarys_patient?.reference_contact || "",
        reference_relation: beneficiarys_patient?.reference_relation || "",
        approved: !!beneficiarys_patient?.approved,
        approver_sign: beneficiarys_patient?.approver_sign || "",
        did: beneficiarys_patient?.did || "",
        approval_date: beneficiarys_patient?.approval_date || null,
        application: !!beneficiarys_patient?.application,
        beneficiary_cnic_submitted: !!beneficiarys_patient?.beneficiary_cnic_submitted,
        prescription: !!beneficiarys_patient?.prescription,
        patient_type: beneficiarys_patient?.patient_type || "",
    });

    const submit = (e) => {
        e.preventDefault();
        patch(route('beneficiarys-patients.update', beneficiarys_patient.id), {
            preserveScroll: true,
            preserveState: true,
        });
    };
