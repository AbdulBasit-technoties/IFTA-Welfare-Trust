...
export default function Index({ auth, beneficiaryData, beneficiaries, payments, paymentStatus }) {
                        ...
                        <div className="left-side py-6 px-4 bg-white">
                            <div className="left-side-item">
                                ...
                                <ul className="text-gray-500 space-y-3 pl-1 pb-6">
                                    <li className="flex items-center gap-3"><FaRegUser />{beneficiaryData.name}</li>
                                    <li className="flex items-center gap-3"><AiOutlineMail />{beneficiaryData.email}</li>
                                    <li className="flex items-center gap-3"><MdOutlinePhone />{beneficiaryData?.beneficiaries[0]?.beneficiary_contact_no ?? 'N/A'}</li>
                                    <li className="flex items-center gap-3"><IoLocationOutline />{beneficiaryData.beneficiaries[0]?.address ?? 'N/A'}</li>
                                </ul>
                            </div>
                            <div className="left-side-item">
