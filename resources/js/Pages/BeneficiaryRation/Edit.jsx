...
export default function Index({ auth, MaritalStatus, patientGender, beneficiarys_ration,donors }) {
    const { data, setData, patch, errors } = useForm({
        beneficiary_name: beneficiarys_ration?.beneficiary_name || "",
        guardian_name: beneficiarys_ration?.guardian_name || "",
        beneficiary_cnic: beneficiarys_ration?.beneficiary_cnic || "",
        guardian_cnic: beneficiarys_ration?.guardian_cnic || "",
        beneficiary_contact_no: beneficiarys_ration?.beneficiary_contact_no || "",
        guardian_contact_no: beneficiarys_ration?.guardian_contact_no || "",
        occupation: beneficiarys_ration?.occupation || "",
        date_of_birth: beneficiarys_ration?.date_of_birth || null,
        gender: beneficiarys_ration?.gender || "",
        marital_status: beneficiarys_ration?.marital_status || "",
        sign: beneficiarys_ration?.sign || "",
        household_income: beneficiarys_ration?.household_income ?? 0,
        syed: !!beneficiarys_ration?.syed,
        orphan: !!beneficiarys_ration?.orphan,
        family_members: beneficiarys_ration?.family_members ?? 1,
        address: beneficiarys_ration?.address || "",
        reference_name: beneficiarys_ration?.reference_name || "",
        reference_contact: beneficiarys_ration?.reference_contact || "",
        reference_relation: beneficiarys_ration?.reference_relation || "",
        approved: !!beneficiarys_ration?.approved,
        approver_sign: beneficiarys_ration?.approver_sign || "",
        did: beneficiarys_ration?.did || "",
        approval_date: beneficiarys_ration?.approval_date || null,
        beneficiary_cnic_submitted: !!beneficiarys_ration?.beneficiary_cnic_submitted,
        last_utility_bill: !!beneficiarys_ration?.last_utility_bill,
        disability: beneficiarys_ration?.disability || "",
        description: beneficiarys_ration?.description || "",
        type: "Monthly Ration",
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        patch(route('beneficiarys-rations.update',beneficiarys_ration.id), {
            preserveScroll: true,
            preserveState: true,
        });
    };
